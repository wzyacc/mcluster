...
#coding:utf8
'''
秒拍app日活任务,总体任务调度不在这处理，只要考虑本任务即可
task原始任务格式
{
    'tid':"12344-1",
...
class AppIdleMiaopai(TaskerBase):
    
    act = 'app-idle-miaopai'
    ...
    def transfer_device(self):
        ...
        for dev_info in devs:
            ...
            if not fake_attr_str or fake_attr_str == "":
                print "AppIdleMiaopai->No fake device attribute for cip:"+ip
                return False
    ...
    def transfer_net(self):
        ...
        for dev_info in devs:
            ...
            if oarea:
                ...
                print "AppIdleMiaopai->oarea is None for cip:"+ip
