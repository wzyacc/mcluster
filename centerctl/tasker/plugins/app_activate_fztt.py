...
#coding:utf8
'''
疯转头条app激活广告任务,总体任务调度不在这处理，只要考虑本任务即可
task原始任务格式
{
    'tid':"12344-1",
...
class AppActiveFztt(TaskerBase):
    ...
    def transfer_done(self):
        ...
        while True:
            ...
            print "Not hit for fztt-active for rd:{0},edge:{1}".format(rd,edge)
            time.sleep(30)
