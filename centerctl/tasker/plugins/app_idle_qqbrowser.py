...
#coding:utf8
'''
qq浏览器app日活任务,总体任务调度不在这处理，只要考虑本任务即可
task原始任务格式
{
    'tid':"12344-1",
...
class AppIdleQQBrowser(TaskerBase):
    
    act = 'app-idle-qqbrowser'
    ...
    def transfer_net(self):
        ...
        for dev_info in devs:
            ...
            if oarea:
                ...
                print "AppIdleQQBrowser->oarea is None for cip:"+ip
